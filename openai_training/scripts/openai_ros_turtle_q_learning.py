#!/usr/bin/env python
"""Example script that can be used to train a Q-learning algorithm on the openai_ros
turtlebot2 environment.

For more information see the
`openai_ros documentation <https://wiki.ros.org/openai_ros/TurtleBot2%20with%20openai_ros>`_
"""  # noqa: E501
...
if __name__ == "__main__":
    ...
    rospy.init_node(
        "example_turtlebot2_maze_qlearn", anonymous=True, log_level=rospy.WARN
    )
    ...
    qlearn = qlearn.QLearn(
        actions=range(env.action_space.n), alpha=Alpha, gamma=Gamma, epsilon=Epsilon
    )
