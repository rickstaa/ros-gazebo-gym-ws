...
class RobotGazeboGoalEnv(gym.GoalEnv):
    def __init__(self, robot_name_space, controllers_list, reset_controls):
        ...
        rospy.loginfo("Entered Gazebo Env")
    ...
    def step(self, action):
        ...
        rospy.loginfo("Set action")
        rospy.loginfo("Action:")
        rospy.loginfo(action)
        self._set_action(action)

        # Retrieve observation
        rospy.loginfo("Get Obs")
        obs = self._get_obs()
    ...
    def reset(self):
        ...
        """
        rospy.logdebug("Reseting RobotGazeboGoalEnvironment")
        rospy.loginfo("Entered reset")
        self._reset_sim()
    ...
    def close(self):
        ...
        """
        rospy.logdebug("Closing RobotGazeboGoalEnvironment")
        rospy.signal_shutdown("Closing RobotGazeboGoalEnvironment")
