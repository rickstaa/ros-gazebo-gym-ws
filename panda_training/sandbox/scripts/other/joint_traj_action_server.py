...
import panda_training.msg


class PandaTrajAction(object):

    # create messages that are used to publish feedback/result
    _feedback = panda_training.msg.FibonacciFeedback()
    _result = panda_training.msg.FibonacciResult()

    def __init__(self, name):
        self._action_name = name
        self._as = actionlib.SimpleActionServer(
            self._action_name,
            actionlib_tutorials.msg.PandaTrajAction,
...
if __name__ == "__main__":
    rospy.init_node("traj_action_test")
