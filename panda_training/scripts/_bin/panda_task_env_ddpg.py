...
class PandaReachTaskEnv(panda_robot_env.PandaRobotEnv, utils.EzPickle):
    def __init__(self):
        ...
        # Retrieve parametesr from parameter server
        rospy.loginfo("Entered Reach Env")
        self.get_params()

        # Initialize parent Class to setup the Robot environment)
        panda_robot_env.PandaRobotEnv.__init__(self)
        ...
        #     -np.inf, np.inf, shape=(14,), dtype="float32"
        # )
    ...
    def _compute_reward(self, observations, done):
        ...
        """
        # NOTE: This contains our reward function
    ...
    def _get_params(self, param_name):
        ...
        try:
            ...
            rospy.logwarn(
                ...
                "reach_sim_config.yaml and that this yaml file is loaded." % param_name
            )
