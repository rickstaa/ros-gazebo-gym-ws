...
# VIDEO_DIR = "./videos/"
# SAVE_MODEL_DIR = "./models/{}".format(NAME)
# LOAD_MODEL_DIR = "./models/morvan-ddpg-panda-reach-1586088349"
...
def train():
    ...
    if os.path.isdir(path):
        shutil.rmtree(path)
    os.mkdir(path)
    ckpt_path = os.path.join("./models/" + MODE[n_model], "DDPG.ckpt")
