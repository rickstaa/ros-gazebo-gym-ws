"""Setup file of the `panda_training` python package.
"""
...
date_files_relative_path = os.path.join(relative_site_packages, "panda_training")
...
setup(
    name="panda_training",
    version=__version__,
    description=("Project code for the panda_training package."),
