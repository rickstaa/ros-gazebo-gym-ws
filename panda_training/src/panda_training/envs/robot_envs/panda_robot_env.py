...
from panda_training.extras import EulerAngles, Quaternion
...
from panda_training.msg import FollowJointTrajectoryAction
...
class PandaRobotEnv(RobotGazeboGoalEnv):
    ...
    def set_ee_pose(self, ee_pose):
        ...
        Parameters
        ----------
        ee_pose :  geometry_msgs.msg.Pose(Stamped), panda_training.msg.SetEePoseRequest,
    ...
    def set_joint_positions(self, joint_positions, wait=None):
        ...
        Parameters
        ----------
        joint_positions : panda_training.msg.SetJointPositionsRequest, dict, list,
    ...
    def set_joint_efforts(self, joint_efforts, wait=None):
        ...
        Parameters
        ----------
        joint_efforts : panda_training.SetJointEffortsRequest, dict, list, tuple, int,
